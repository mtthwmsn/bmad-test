        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.competitors.update', $competitor) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="first_name" id="first_name" value="{{ old('first_name', $competitor->first_name) }}" required
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="last_name" id="last_name" value="{{ old('last_name', $competitor->last_name) }}" required
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="bar_name" id="bar_name" value="{{ old('bar_name', $competitor->bar_name) }}"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="country_code" id="country_code" value="{{ old('country_code', $competitor->country_code) }}" required
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="instagram" id="instagram" value="{{ old('instagram', $competitor->instagram) }}"
                        ...
                        <div class="mb-6">
                            ...
                            <input type="url" name="diffords_profile" id="diffords_profile" value="{{ old('diffords_profile', $competitor->diffords_profile) }}"
